function [cost, grad, storedb] = getCostGrad1(problem, x, storedb,H,Vn,N_RF)
...
% Change log: 
    ...
    %% Revert to calling getCost and getGradient separately
        ...
        [cost, storedb] = getCost1(problem, x, storedb,H,Vn,N_RF);
        [grad, storedb] = getGradient1(problem, x, storedb,H,Vn,N_RF);
