function [x, cost, info, reason, options] = conjugategradient1(problem, x,H,Vn,N_RF, options)
...
[cost grad storedb] = getCostGrad1(problem, x, storedb,H,Vn,N_RF);
...
%                      'steepest descent direction.\n'], df0);
    ...
    % Execute line search
    [stepsize newx storedb lsmem lsstats] = linesearch_adaptive1(...
                 problem, x, desc_dir, cost, df0, options, storedb, lsmem,H,Vn,N_RF);


    % Compute the new cost-related quantities for x
    [newcost newgrad storedb] = getCostGrad1(problem, newx, storedb,H,Vn,N_RF);
